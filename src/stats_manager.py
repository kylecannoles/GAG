...
class StatsManager(object):
    increment_stats = ["Total sequence length", "Number of genes",
                       ...
                       "CDS: start, no stop", "CDS: stop, no start", "CDS: no stop, no start",
                       "Total gene length", "Total mRNA length", "Total exon length",
                       "Total intron length", "Total CDS length"]

    min_stats = ["Shortest gene", "Shortest mRNA", "Shortest exon", "Shortest intron",
                 "Shortest CDS"]
    ...
    calc_stats_formulae = {"mean gene length": ["Total gene length", "Number of genes"],
                           ...
                           "% of genome covered by genes": ["Total gene length",
                                                            "Total sequence length"],
                           "% of genome covered by CDS": ["Total CDS length",
                                                          "Total sequence length"],
    ...
    def summary(self):
        ...
        stats_order = [key for keys in [self.increment_stats, self.min_stats, self.max_stats,
                                        self.calc_stats] for key in keys]
