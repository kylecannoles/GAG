...
class TestGFFReader(unittest.TestCase):
    ...
    def test_validate_line_not_enough_fields(self):
        ...
        self.assertFalse(validate_line(badline))
    ...
    def test_validate_line_indices_out_of_order(self):
        badline = "scaffold00080\tmaker\tgene\t109853\t106151\t.\t+\t.\tID=BDOR_007864;Name" \
                  "=BDOR_007864\n"
        self.assertFalse(validate_line(badline))

    def test_validate_line(self):
        goodline = "scaffold00080\tmaker\tgene\t106151\t109853\t.\t+\t.\tID=BDOR_007864\n"
        self.assertTrue(validate_line(goodline))

    def test_line_type_gene(self):
        line = ['scaffold00080', 'maker', 'gene', '106151', '109853', '.', '+', '.',
                'ID=BDOR_007864\n']
        self.assertEqual('gene', line_type(line))

    def test_line_type_mrna(self):
        line = ['scaffold00080', 'maker', 'mRNA', '106151', '109853', '.', '+', '.',
                'ID=BDOR_007864-RA;Parent=BDOR_007864\n']
        self.assertEqual('mRNA', line_type(line))

    def test_line_type_exon(self):
        line = ['scaffold00080', 'maker', 'exon', '106151', '106451', '0.9', '+', '.',
                'ID=BDOR_007864-RA:exon:0;Parent=BDOR_007864-RA\n']
        self.assertEqual('exon', line_type(line))

    def test_line_type_cds(self):
        line = ['scaffold00080', 'maker', 'CDS', '106151', '106451', '.', '+', '0',
                'ID=BDOR_007864-RA:cds:0;Parent=BDOR_007864-RA\n']
        self.assertEqual('CDS', line_type(line))

    def test_line_type_start_codon(self):
        line = ['scaffold00080', 'maker', 'start_codon', '106151', '106153', '.', '+', '.',
                'ID=BDOR_007864-RA:start1;Parent=BDOR_007864-RA\n']
        self.assertEqual('start_codon', line_type(line))

    def test_line_type_stop_codon(self):
        line = ['scaffold00080', 'maker', 'stop_codon', '109851', '109853', '.', '+', '.',
                'ID=BDOR_007864-RA:stop2;Parent=BDOR_007864-RA\n']
        self.assertEqual('stop_codon', line_type(line))

    def test_parse_attributes(self):
        attr = "ID=BDOR_007864-RA:stop2;Parent=BDOR_007864-RA\n"
        parsed = parse_attributes(attr)
    ...
    def test_update_cds(self):
        current_cds = Mock()
        line = ['scaffold00080', 'maker', 'CDS', '106509', '106749', '.', '+', '2',
                'ID=BDOR_007864-RA:cds:1;Parent=BDOR_007864-RA\n']
        update_cds(line, current_cds)
    ...
    def test_update_exon(self):
        current_exon = Mock()
        line = ['scaffold00080', 'maker', 'exon', '106509', '106749', '8.34', '+', '2',
                'ID=BDOR_007864-RA:exon:1;Parent=BDOR_007864-RA\n']
        update_exon(line, current_exon)
